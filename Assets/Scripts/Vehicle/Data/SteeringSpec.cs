...
namespace Touge.Vehicle.Data
{
    ...
    public class SteeringSpec
    {
        ...
        public float maxSteerAngleDeg = 44f;
        ...
        public AnimationCurve speedSensitivityCurve = new AnimationCurve(
            new Keyframe(0f, 1f),
            new Keyframe(40f, 0.95f),
            new Keyframe(90f, 0.88f),
            new Keyframe(160f, 0.82f));
        ...
        public float steerRateDegPerSec = 300f;
        ...
        public float returnRateDegPerSec = 430f;
